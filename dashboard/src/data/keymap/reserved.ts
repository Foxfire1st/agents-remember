...
export const BROWSER_FORBIDDEN = [
  ...
  "ctrl+8",
  "ctrl+9",
  // macOS/browser equivalents. These must be listed independently: KeyboardEvent exposes the
  // Command key as Meta, never Control. Cmd+Q is the OS-level quit chord even though the closest
  // Windows/Linux sibling above is Ctrl+Shift+Q.
  "meta+w",
  "meta+t",
  "meta+n",
  "meta+q",
