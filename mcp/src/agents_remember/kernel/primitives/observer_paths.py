...
Kernel owns the path conventions so the serving projection readers, the
observer write side, worktrees and memory_quality can all resolve the same
roots without crossing packages.
