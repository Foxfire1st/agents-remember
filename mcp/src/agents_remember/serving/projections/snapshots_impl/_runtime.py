...
from agents_remember.serving.projections.snapshots_impl._analytics import _ledger_window
        ...
        for entry in store.current().values():
            ...
            pickups.append(
                AgentPickupNode(
                    ...
                    taskDocumentRef=entry.taskDocumentRef,
                    subjectTaskDocumentRef=entry.subjectTaskDocumentRef,
                    senderAgentId=entry.senderAgentId,
                    senderRole=entry.senderRole,
                    recipientRole=entry.recipientRole,
                    ownerRole=entry.ownerRole,
                    ownerTaskDocumentRef=entry.ownerTaskDocumentRef,
        ...
        for row in store.pending_for_projection():
            ...
            rows.append(
                ExpectationRowNode(
                    ...
                    taskDocumentRef=row.taskDocumentRef,
                    dueAt=row.dueAt,
                    overdue=overdue,
                    note=row.note,
                )
