...
> houses at the **designer** seat. It carries both axes: the **role** (co-think a master task with the
> developer) and the **lens** (meta-question · reframe-before-execution · evidence-first). A
> `jobs/designer.<harness>.md` overlay may add harness-specific knobs; none ships yet.
>
