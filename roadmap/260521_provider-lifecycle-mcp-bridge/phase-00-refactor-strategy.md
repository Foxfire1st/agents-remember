...
- Do not move mutation-heavy provider lifecycle operations into the first MCP slice.
...
6. Rewire skills toward the MCP read surface.
7. Extract provider query and provider lifecycle services after the first slice proves the boundary.
