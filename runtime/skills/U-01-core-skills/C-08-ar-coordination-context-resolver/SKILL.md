...
- `C-03-repo-bootstrap`, `C-04-onboarding-read-mode`, `C-05-create-or-update-onboarding-files`, and task workflows use the resolved roots instead of rebuilding topology rules.
